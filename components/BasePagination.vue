    ...
    <div class="flex flex-col items-center">
        ...
        <span class="text-sm text-gray-700 dark:text-gray-400">
            ...
            <span class="font-semibold text-gray-900 dark:text-white">{{
                (props.modelValue - 1) * props.limit + 1
            }}</span>
            to
            <span class="font-semibold text-gray-900 dark:text-white">{{
                props.limit * props.modelValue < props.total
                    ? props.limit * props.modelValue
                    : props.total
            }}</span>
            of
            <span class="font-semibold text-gray-900 dark:text-white">{{
...
const handleInscrese = () => {
    if (props.modelValue * props.limit >= props.total) {
        return;
    }
    emit("update:modelValue", props.modelValue + 1);
};
